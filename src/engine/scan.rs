...
mod tests {
    ...
    fn test_scan_actionable_managers_subset_of_available() {
        ...
        // This test would have caught the bug where actionable_managers was set to Default::default()
    ...
    fn test_scan_actionable_managers_not_empty_when_managers_available() {
        ...
        if !report.available_managers.is_empty() {
            assert!(
                ...
                "When package managers are available, at least some should be actionable. \
                 Found {} available managers but 0 actionable managers. \
                 This indicates a bug in populating actionable_managers.",
